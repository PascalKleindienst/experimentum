...
class TestPerformance(object):
    ...
    def test_load_exp(self, tmpdir, capsys):
        with tmpdir.join('FooExperiment.py').open('w+') as fh:
            fh.write(
        ...
        assert isinstance(Experiment.load(tmpdir.strpath, 'Foo'), Experiment)
